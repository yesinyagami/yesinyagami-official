  ...
  },
  {
    ...
    meanings: {
      ...
      reversed: {
        ...
        career: 'Misuse of skills, lack of focus, wasted potential.',
        spiritual: 'Spiritual manipulation, ego-driven actions, blocked energy.'
      }
    },
    image: '/assets/02_The_Magician.png',
    description: 'The Magician holds the tools of manifestation, connecting heaven and earth.',
    element: 'air'
  },
  {
    id: '3',
    ...
    keywords: {
      ...
      reversed: ['blocked intuition', 'secrets', 'withdrawal']
    },
    meanings: {
      upright: {
        general: 'The High Priestess represents intuition, sacred knowledge, divine feminine, and the subconscious mind. Trust your inner voice.',
        love: 'Intuitive understanding in love, deep emotional connections, feminine wisdom.',
        career: 'Trust your instincts, hidden knowledge, working behind the scenes.',
        spiritual: 'Spiritual mysteries, inner wisdom, connection to the divine feminine.'
      },
      reversed: {
        general: 'Reversed, she can indicate blocked intuition, secrets, or withdrawal from the world.',
        love: 'Lack of emotional depth, secrets in relationships, disconnection.',
        career: 'Ignoring intuition, hidden agendas, lack of insight.',
        spiritual: 'Spiritual disconnection, blocked psychic abilities, ignoring inner voice.'
      }
    },
    image: '/assets/03_The_High_Priestess.png',
